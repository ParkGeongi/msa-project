...
class AAAA:
    ...
    def test1(self):
        p = Preprocess(word2index_dic=r'C:\Users\AIA\project\FastApi\app\services\intent\data\chatbot_dict.bin',
                       userdic=r'C:\Users\AIA\project\FastApi\app\services\intent\data\user_dic.tsv')
        ...
        # NER 예측
        model = load_model(r'C:\Users\AIA\project\FastApi\app\services\ner\save\ner_model.h5')
        p = model.predict(np.array([new_padded_seqs[0]]))
        p = np.argmax(p, axis=-1)  # 예측된 NER 인덱스 값 추출

        print("{:10} {:5}".format("단어", "예측된 NER"))
        print("-" * 50)
        index_to_ner = {1: 'O', 2: 'B_DT', 3: 'B_FOOD', 4: 'I', 5: 'B_OG', 6: 'B_PS', 7: 'B_LC', 8: 'NNP', 9: 'B_TI',
                        0: 'PAD'}

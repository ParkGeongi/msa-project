...
class INTENTModel:
    ...
    def training(self):
        # 데이터 읽어오기
        train_file = r"C:\Users\AIA\project\FastApi\app\services\chatbot\intent\data\total_train_data.csv"
        ...
        # 모델 저장  ○8
        model.save(r'C:\Users\AIA\project\FastApi\app\services\chatbot\intent\save\intent_model.h5')
